...
SRCS := $(SRC_DIR  )/main.c $(SRC_DIR)/s2p.c $(SRC_DIR)/mui.c $(SRC_DIR)/gra.c $(SRC_DIR)/uti.c $(SRC_DIR)/mma.c $(SRC_DIR)/mui_platform_raylib.c
OBJS := $(BUILD_DIR)/main.o $(BUILD_DIR)/s2p.o $(BUILD_DIR)/mui.o $(BUILD_DIR)/gra.o $(BUILD_DIR)/uti.o $(BUILD_DIR)/mma.o $(BUILD_DIR)/mui_platform_raylib.o
HEADER_DEPS :=
